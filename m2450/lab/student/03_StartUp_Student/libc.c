 ...
 * =====================================================================
 */
// volatile unsigned int* HWGPGCON = (unsigned int*)0x56000060; // R/W Configures the pins of port G 0x0
// volatile unsigned int* GPGDAT = (unsigned int*)0x56000064; //R/W The data register for port G
void Led_Port_Init(void)
{	
	/* 
	 * LED On : Active Low 
	...
	rGPGCON = (rGPGCON &~(0xf<<8))|(0x5<<8);
	rGPGDAT = (rGPGDAT &~(0x3<<4));
...
void Led_Display(int data)
{
	...
	// *HWGPGCON = (HWGPGCON &~(0xff<<8))|(0x55<<8); 
	// *HWGPGDAT = (*HWGPGDAT &~ (0xf<<4));
}
