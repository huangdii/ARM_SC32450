...
static unsigned int Fbuf[6] = {0x33800000, 0x33c00000, 0x33f00000, 0x34300000, 0x34700000, 0x34b00000};
...
void Lcd_Put_Pixel(int x,int y,int color)//make a particular point on LCD
{
...
// Clear screen
void Lcd_Clr_Screen(unsigned long color) // drawing line
{
	int i,j;
...
void Lcd_Draw_BMP(int x, int y, const unsigned char *fp)
{
     ...
     for(yy=0;yy<biHeight;yy++)  //272 height
     {
         for(xx=0;xx<biWidth;xx++) //480 width
         {
