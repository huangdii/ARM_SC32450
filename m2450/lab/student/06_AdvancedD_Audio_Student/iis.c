...
{
   int i;
   IIC_open(100000); // I2C CODE START 
...
{	
	...
	unsigned long HEART_ADDR = (unsigned long)0x37000000;
	Uart_Printf("\n Speak Play \n");

	wave_size = *(unsigned int *)(HEART_ADDR + 0x28); //0x28 = 40
	fs = *(unsigned int *)(HEART_ADDR + 0x18);
	wave_start_addr = HEART_ADDR+44;
