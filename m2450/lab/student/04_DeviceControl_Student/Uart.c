...
void Uart_Init(int baud)
{
    ...
    //rUBRDIV1= ((unsigned int)(660000000/16./38400+0.5)-1 );
}
...
void Uart_Send_Byte(int data)
{
    ...
    while(!(rUTRSTAT1 & 0x2));	// uart register: library control
    WrUTXH1(data);
    //(*(volatile unsigned char *)0x50004023)='h';
}
...
char Uart_GetChar(void)
{
    ...
    /* YOUR CODE HERE */  
    while(!(rUTRSTAT1 & (1<<0)));  //while regsister is empty 
    return RdURXH1();
